...
def main():
    '''
    Honestly, using an h_size of 25, LR 0.2, and batch of 100 made a better model
    than my ADA and combined PCA_NN with 1000 epochs. Maybe smaller layers are better?
    '''
    nEpochs=200 #
...
#https://nathanbrixius.wordpress.com/2016/05/23/a-simple-predictive-model-in-tensorflow/ Might help?				
    ...
    for epoch in range(nEpochs):
        ...
        for i in range(nBatches):
            ...
            sess.run(updates, feed_dict={X: all_X[n:n+batch_size], y:all_Y[n:n+batch_size], p_keep:0.5, p_keep_hidden:0.8})
            n+=batch_size
